...
const toReplayEvent = (event: HandHistoryEvent): HoldemReplayEvent => {
...
const toReplayTableEvent = (event: HandHistory["tableEvents"][number]) => {
  const payload = asObject(event.payload);
...
export const buildHoldemReplayData = (
  history: HandHistory,
): HoldemReplayData | null => {
...
export const buildHoldemDisputePayload = (
  history: HandHistory,
...
export const buildHoldemHandEvidence = (
  history: HandHistory,
...
export const findReplayParticipant = (
