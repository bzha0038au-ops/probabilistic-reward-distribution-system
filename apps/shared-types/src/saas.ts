...
export const PrizeEngineDrawResultSchema = z.object({
  ...
  fairness: z
    .object({
      ...
      selectedArmScore: z.number().nullable().optional(),
      selectedArmProbability: z.number().min(0).max(1).nullable().optional(),
      priorAlpha: z.number().positive().nullable().optional(),
      priorBeta: z.number().positive().nullable().optional(),
      priorStrength: z.number().positive().nullable().optional(),
      scoreNormalizationMax: z.number().positive().nullable().optional(),
