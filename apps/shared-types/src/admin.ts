...
export const SystemConfigPatchSchema = z.object({
  ...
  maintenanceMode: OptionalBooleanSchema,
  registrationEnabled: OptionalBooleanSchema,
  loginEnabled: OptionalBooleanSchema,
  drawEnabled: OptionalBooleanSchema,
  paymentDepositEnabled: OptionalBooleanSchema,
  paymentWithdrawEnabled: OptionalBooleanSchema,
  antiAbuseAutoFreezeEnabled: OptionalBooleanSchema,
  withdrawRiskNewCardFirstWithdrawalReviewEnabled: OptionalBooleanSchema,
