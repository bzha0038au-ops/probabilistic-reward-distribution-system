...
export async function registerUserRoutes(app: FastifyInstance) {
  app.register(async (protectedRoutes) => {
    ...
    protectedRoutes.post('/draw', async (request, reply) => {
      const user = request.user!;
    ...
    protectedRoutes.post('/bank-cards', async (request, reply) => {
      const user = request.user!;
    ...
    protectedRoutes.patch('/bank-cards/:bankCardId/default', async (request, reply) => {
      const user = request.user!;
    ...
    protectedRoutes.post('/top-ups', async (request, reply) => {
      const user = request.user!;
      const payload = request.body as {
    ...
    protectedRoutes.post('/withdrawals', async (request, reply) => {
      const user = request.user!;
      const payload = request.body as {
        amount?: number | string;
